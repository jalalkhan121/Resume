		...
		?>
          ...
          <div class="<?php echo $colLg; ?> pt-4 pt-lg-0 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-cake2"></i> <strong>Birthday:</strong> <span><?php echo @$dob?@$dob:''; ?></span></li>
              ...
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-clock-fill"></i> <strong>Age:</strong> <span><?php echo @$age?@$age:''; ?></span></li>

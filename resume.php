...
<?php 
		if(isset($_POST['eduDegreeTitle']) && !empty($_POST['eduDegreeTitle'])) { 
			$degreeStr = end($_POST['eduDegreeTitle']);
		} else {
			$degreeStr = "Degree Title";
		}
		
		if(isset($_POST['eduDegreeInstitute']) && !empty($_POST['eduDegreeInstitute'])) { 
			$eduDegreeInstitute = end($_POST['eduDegreeInstitute']);
		} else {
			$eduDegreeInstitute = "Institute Title";
		}
			
?>
        <div class="section-title">
          <h2><i class="bx bx-briefcase-alt-2"></i> Education</h2>
          <p>Earned a <?php echo $degreeStr ?> from <?php echo $eduDegreeInstitute ?>, focusing on market requirement. Developed strong skills in research, data analysis, and specific techniques/technologies. The rest degrees are mentioned as follows.</p>
        </div>
        ...
        <section id="portfolio" class="resume">
          ...
          <p>With a well-established career background in my chosen field, I have honed a strong all-around skill base through on-field experience and collaboration with a multidisciplinary setup. My expertise encompasses handling projects, timely deliverance of results, and good client relations. I show consistently high adaptability and problem-solving skills to bring high-quality solutions. Dedicated to ongoing growth and development, I am continually working to further deepen my knowledge while being able to contribute towards overall organizational achievement at the same time, staying constantly positive and proactive in any career challenge.
</p>
        </div>
        <div class="row">
        <?php
    ...
    <section id="portfolio" class="resume">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>My portfolio showcases a diverse range of projects, demonstrating my expertise in skills, areas, and technologies It highlights my ability to solve complex problems, deliver innovative solutions, and work collaboratively. Explore my work to see my approach and results.</p>
        </div>
